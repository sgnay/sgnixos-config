...
let
  ...
  commonInbounds = [
    { port = 1080; listen = "0.0.0.0"; protocol = "http";
  ...
  awayDns = {
    ...
    servers = [
      ...
      { address = "223.5.5.5"; domains = [ "geosite:private" "domain:alidns.com" "domain:doh.pub" "domain:dot.pub" "domain:360.cn" "domain:onedns.net" ]; skipFallback = true; tag = "domestic-dns0"; }
      { address = "223.5.5.5"; domains = [ "geosite:cn" ]; expectIPs = [ "geoip:cn" ]; skipFallback = true; tag = "domestic-dns0_cn_expect"; }
    ];
    tag = "dns-module";
  };
  ...
  awayRules = [
    ...
    # Google 走代理
    { type = "field"; domain = [ "geosite:google" ]; outboundTag = "proxy-xhttp"; }
    # 私有地址直连
    { type = "field"; ip = [ "ext:geoip.dat:private" ]; outboundTag = "direct"; }
    { type = "field"; domain = [ "geosite:private" ]; outboundTag = "direct"; }
    # 国内 DNS 服务器直连
    { type = "field"; ip = cnDnsIps; outboundTag = "direct"; }
    { type = "field"; domain = [ "domain:alidns.com" "domain:doh.pub" "domain:dot.pub" "domain:360.cn" "domain:onedns.net" ]; outboundTag = "direct"; }
    # 国内 IP/域名直连
